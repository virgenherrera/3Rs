...
if(isset($_SESSION['3rs_mexico'])){
    ...
    <body>
    <h2>en esta pagina puedes EDITAR un<br>nuevo LENGUAJE para la seccion: <a href="../index.php" target="_blank">QUIENES SOMOS</a></h2>
	...
	?>
    <form action="php/editar_idioma.php" method="post">
        <fieldset>
