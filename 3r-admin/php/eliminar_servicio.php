...
if(	isset($_POST['id_servicio']) and !empty($_POST['id_servicio'])){
	
	//eliminar registro del producto de la bdd
	$consulta = 'DELETE FROM servicios WHERE id_servicio = ' . $_POST['id_servicio'];
	insertar_mysql($consulta);
	
	//redirigir tras el proceso exitoso
	header('Location: ../panel-de-control.php?msg=del_serv_succ');
}
?>